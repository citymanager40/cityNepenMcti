# Define o caminho onde o arquivo README.md será criado
$readmePath = ".\Documentation\Architecture\README.md"

# Verifica se o diretório "Documentation\Architecture" existe; caso contrário, cria-o
$directoryPath = ".\Documentation\Architecture"
if (-Not (Test-Path $directoryPath)) {
    New-Item -Path $directoryPath -ItemType Directory
}

# Define o conteúdo do arquivo README.md
$readmeContent = @"
...
Todas as dependências devem ser declaradas no arquivo `requirements.txt`. Sem exceções.
...
# Cria ou atualiza o arquivo README.md com o conteúdo definido
