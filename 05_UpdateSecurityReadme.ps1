# 04_UpdateSecurityPoliciesReadme.ps1

# Caminho para o arquivo README.md dentro da pasta Documentation\SecurityPolicies
$readmePath = ".\Documentation\SecurityPolicies\README.md"
